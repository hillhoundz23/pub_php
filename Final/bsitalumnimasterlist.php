...
if (isset($_SESSION["ausername"])){
	...
	session_write_close();
   $course="BSIT"; 
   $queryStudentinfor = "select * from alumni where course='$course' order by Lname";
   ...
   <div style="margin-top:23px" class="navbar-collapse offcanvas-collapse justify-content-md-center"id="navbarCollapse"> 
    <script src="https://code.jquery.com/jquery-3.5.1.slim.min.js" integrity="sha384-DfXdz2htPH0lsSSs5nCTpuj/zy4C+OGpamoFVy38MVBnE+IbbVYUew+OrCXaRkfj" crossorigin="anonymous"></script>
      ...
      <ul class="navbar-nav dropdown">
         ...
         <ul class="navbar-nav dropdown font-weight-bold active"><a class="nav-link" href="#"style="text-decoration: underline;color: #b3fbad">BSIT Alumni</a></ul>
...
<table class="table-sm" style="border:3px solid #000;text-align:center">
      ...
      <tr style="border:1px solid #000;background-color:#b9e4e3">
       ...
       <td scope="row" style="border:1px solid #000;background-color:aqua"><?php echo $result['Address'];?></td>
		  ...
		  <td scope="row" style="border:1px solid #000;background-color:aqua"><?php $jobs=explode("*",$result['Job']); echo $jobs['0']."/";echo $result['Employment']; if($result['Related']=="Yes"){echo "/"."Related";}?></td>

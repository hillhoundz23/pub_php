...
if ($result=mysqli_query($connection,"select(select count(id) FROM alumni where course='$course') as 'TA',(select count(id) FROM alumni where course='$course' and employment='Unemployed') as TU,(select count(id) FROM alumni where course='$course' and Employment='Employed') as TE,(select count(id) FROM alumni where course='$course' and Employment='Employed' and Related='Yes') as TR,(select count(id) FROM alumni where course='$course' and Employment='Employed' and Related='No') as TN")){
...
.bd-placeholder-img { 
    ...
    <nav style="height:100px;" class="navbar navbar-expand-lg fixed-top navbar-dark">
      ...
      <a href="home.php" class="Titles" style="Color:white;font-size:140%;"><img class="mr-3" src="logo.png" alt="" width="332" height="51"></a>
   ...
   <div style="margin-top:23px" class="navbar-collapse offcanvas-collapse justify-content-md-center"id="navbarCollapse"> 
    <script src="https://code.jquery.com/jquery-3.5.1.slim.min.js" integrity="sha384-DfXdz2htPH0lsSSs5nCTpuj/zy4C+OGpamoFVy38MVBnE+IbbVYUew+OrCXaRkfj" crossorigin="anonymous"></script>
      ...
      <ul class="navbar-nav dropdown">
         <a  class="nav-link" href="coursedash.php"style="color:white" ><?php echo strtoupper($course); ?> ALUMNI DASHBOARD</a></ul>
         ...
         <ul class="navbar-nav dropdown font-weight-bold active"><a class="nav-link" href="#"style="text-decoration: underline;color: #b3fbad">Master List</a></ul>
         <ul class="navbar-nav dropdown">
...
<button class="btn btn-outline-primary" style="border-radius:4px;border:1px solid #000;text-align:center;">Print <?php echo strtoupper($course);?> Master List</button>
<div class="row"id="table" >	
<label class="col-12 strong font-weight-bolder" style="font-size:1.9rem;text-align:center;color:white;"><?php echo strtoupper($course);?> MASTER LIST</label>
<table class="table-sm" style="border:3px solid #000;text-align:center">
      ...
      <tr style="border:1px solid #000;background-color:#b9e4e3">
       ...
       <td scope="row" style="border:1px solid #000;background-color:aqua"><?php echo $result['Address']?></td>
		  ...
		  <td scope="row" style="border:1px solid #000;background-color:aqua"><?php echo $result['Job']?></td>
